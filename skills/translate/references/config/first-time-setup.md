...
options:
   - label: "User (Recommended)"
     description: "$HOME/.translate/ (all projects)"
   - label: "Project"
     description: ".translate/ (this project only)"

## Save Locations

| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.translate/EXTEND.md` | All projects |
| Project | `.translate/EXTEND.md` | Current project |
